...
export default function Services() {
  ...
  const label = (cat) => t(`services.categories.${CAT_LABEL_KEY[cat] || cat}`);
  ...
  if (!cat) {
    ...
    return (
      <section
        ref={servicesRef}
        id="services"
        className="scroll-mt-16 py-12 sm:py-16 md:py-20 lg:py-24 bg-white"
      >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.currentTarget.src = placeholderImages[key];
                    }}
                  />
  ...
  return (
    ...
    ref={servicesRef}
      id="services"
      className="scroll-mt-16 py-12 sm:py-16 md:py-20 bg-white"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
