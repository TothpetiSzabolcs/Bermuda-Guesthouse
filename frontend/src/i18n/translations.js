export const translations = {
  hu: {
    ...
    hero: {
      titlePrefix: "Kikapcsolódás, élmények, hagyományok – mindez a ",
      highlight: "Bermuda Vendégházban!",
      description:
      ...
      cta: "Szobák megtekintése",
      contact: "Kapcsolatfelvétel",
      map: "Térkép",
      hideMap: "Elrejtés",
      loadMap: "Térkép betöltése",
      planRoute: "Útvonal tervezése",
      badge: "Bermuda Vendégház",
      rating: "4.9 értékelés (127 vélemény)",
    },
    ...
    experiences: {
      ...
      items: {
        offroad: {
          title: "Off-road túra",
          desc: "Adrenalin és kaland erdei utakon, vezetett terepjárós túrával.",
        },
        lakeside: {
          title: "Tóparti pihenés",
          desc: "Napozás, piknik, esti grill – nyugodt kikapcsolódás a vízparton.",
        },
        village: {
          title: "Falusi élmények",
          desc: "Kemence, bogrács, helyi ízek és hagyományok kézműves programokkal.",
        },
      },
    },
    ...
    gallery: {
      ...
      pick: {
        ...
        lead: "Sok fotónk van – előbb válassz kategóriát, hogy átláthatóbb legyen.",
        hint: "Kattints és nézd meg a képeket",
      },
      filters: {
        all: "Összes",
        to: "Tó",
      ...
      empty: "Még nincsenek képek ebben a kategóriában.",
      videoBadge: "Videó",
    },
    ...
    contact: {
      ...
      form: {
        ...
        message: "Üzenet",
        send: "Küldés",
        success: "Üzenet elküldve. Hamarosan válaszolunk!",
      },
    },
    ...
    terms: {
      ...
      sections: {
        ...
        guestObligations: {
          ...
          items: [
            "A szálláshely rendjének és nyugalmának megőrzése",
    ...
    privacy: {
      ...
      sections: {
        ...
        rights: {
          ...
          intro: "A GDPR értelmében Ön jogosult:",
          items: [
            "Tájékoztatást kérni a kezelt adatairól",
            "Helyesbítést kérni a pontatlan adatokon",
    ...
    admin: {
      ...
      gallery: {
        uploadTitle: "Média feltöltése",
        selectFile: "Fájl kiválasztása",
        uploading: "Feltöltés…",
        deleteConfirm: "Biztosan törlöd ezt a médiát?",
        fileTypesHint: "Támogatott: képek és videók (pl. JPG, PNG, MP4, MOV).",
        uploadSuccess: "Feltöltve.",
        deleteSuccess: "Törölve.",
        management: "Galéria kezelése",
        category: "Kategória",
        ...
        searchPlaceholder: "Keresés (alt/publicId/format)",
        type: "Típus:",
        all: "Összes",
        images: "Képek",
        videos: "Videók",
      ...
      rooms: {
        ...
        saveSuccess: "Mentve.",
        loading: "Loading…",
        failedToLoad: "Failed to load room",
        cover: "Cover",
        image: "Image",
        setCover: "Set cover",
        delete: "Delete",
  ...
  en: {
    ...
    hero: {
      titlePrefix: "Relaxation, experiences, traditions – everything at ",
      highlight: "Bermuda Guesthouse!",
      description:
    ...
    experiences: {
      ...
      items: {
        offroad: {
          title: "Off-road tour",
          desc: "Guided 4x4 adventure on forest trails for all skill levels.",
        },
        lakeside: {
          title: "Lakeside relaxation",
          desc: "Sunbathing, picnics, and evening barbecue by the water.",
        },
        village: {
          title: "Village traditions",
          desc: "Wood-fired oven, kettle cooking, and hands-on local crafts.",
        },
      },
    },
    ...
    gallery: {
      ...
      pick: {
        ...
        lead: "We have many photos — pick a category first to keep things tidy.",
        hint: "Click to view",
      },
      filters: {
        all: "All",
    ...
    terms: {
      title: "General Terms and Conditions and Cancellation Policy",
      sections: {
        provider: {
        ...
        guestObligations: {
          ...
          items: [
            "Maintaining order and peace at the accommodation",
    ...
    privacy: {
      ...
      sections: {
        ...
        dataScope: {
          ...
          intro: "During the booking process, we process the following data:",
          items: [
            "Name",
            "Email address",
        ...
        rights: {
          ...
          intro: "Under GDPR, you are entitled to:",
          items: [
    ...
    admin: {
      ...
      gallery: {
        ...
        searchPlaceholder: "Search (alt/publicId/format)",
        type: "Type:",
        all: "All",
        images: "Images",
        videos: "Videos",
  ...
  de: {
    ...
    hero: {
      titlePrefix: "Entspannung, Erlebnisse, Traditionen – alles im ",
      highlight: "Bermuda Gästehaus!",
      description:
    ...
    experiences: {
      ...
      items: {
        offroad: {
          title: "Offroad-Tour",
          desc: "Geführtes 4x4-Abenteuer auf Waldwegen für jedes Niveau.",
        },
        lakeside: {
          title: "Entspannung am See",
          desc: "Sonnenbaden, Picknick und Abendgrill am Wasser.",
        },
        village: {
    ...
    gallery: {
      title: "Galerie",
      lead: "Einblicke in das Gästehaus, die Umgebung und die Aktivitäten.",
      backToCategories: "Zurück zu den Kategorien",
      pick: {
        title: "Kategorie wählen",
        lead: "Wir haben viele Fotos – wähle zuerst eine Kategorie für bessere Übersicht.",
        hint: "Klicken zum Ansehen",
      },
      filters: {
        all: "Alle",
        to: "See",
    ...
    terms: {
      title: "Allgemeine Geschäftsbedingungen und Stornierungsbedingungen",
      sections: {
        provider: {
        ...
        cancellation: {
          ...
          freeLabel: "Kostenlose Stornierung:",
          rules: [
        ...
        guestObligations: {
          ...
          items: [
            "Einhaltung von Ordnung und Ruhe in der Unterkunft",
    ...
    admin: {
      ...
      gallery: {
        ...
        searchPlaceholder: "Suche (Alt/publicId/format)",
        type: "Typ:",
        all: "Alle",
        images: "Bilder",
        videos: "Videos",
      ...
      rooms: {
        ...
        privateBathroom: "Eigenes Bad",
        images: "Bilder",
        descriptionHu: "Beschreibung (HU)",
        descriptionEn: "Beschreibung (EN)",
        descriptionDe: "Beschreibung (DE)",
        saveSuccess: "Gespeichert.",
        loading: "Loading…",
        failedToLoad: "Fehler beim Laden des Zimmers",
        cover: "Cover",
        image: "Bild",
        setCover: "Als Cover festlegen",
        delete: "Löschen",
